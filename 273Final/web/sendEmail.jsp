                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" action="SendEmailMainServlet"method="get">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Tweet 1:</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="ht1" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Tweet 2:</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="ht2" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <button onclick="location.href='/servletManager/SendEmailMainServlet.java'" class="btn btn-default">Search</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
